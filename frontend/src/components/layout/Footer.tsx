  ...
  return (
    <footer className="w-full flex justify-center bg-[#fdf6ff]">
      <div className="w-full">
        ...
        <div className="w-[90%] md:w-[85%] lg:w-[80%] mx-auto py-12 md:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-10 gap-y-12 overflow-hidden">

          {/* Column Group 1: Women Care - now spans 2 columns */}
          <div className="flex flex-col gap-4 col-span-1 sm:col-span-2 lg:col-span-2">
            <h3 className="text-[#6B2D8B] font-bold text-lg mb-4 border-b border-[#6B2D8B]/10 pb-2">Women Care</h3>
          ...
          {/* Column Group 2: Child Care - now spans 2 columns */}
          <div className="flex flex-col gap-4 col-span-1 sm:col-span-2 lg:col-span-2">
            <h3 className="text-[#6B2D8B] font-bold text-lg mb-4 border-b border-[#6B2D8B]/10 pb-2">Child Care</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
              {childCare.map((item) => (
                <li key={item.slug}>
                  <Link
          ...
          {/* Column 3: Hospitals Locations */}
          <div className="flex flex-col gap-4">
            <h3 className="text-[#6B2D8B] font-bold text-lg mb-4 border-b border-[#6B2D8B]/10 pb-2">Our Hospitals</h3>
          ...
          {/* Column 5: Fertility Care */}
          <div className="flex flex-col gap-4">
            <h3 className="text-[#6B2D8B] font-bold text-lg mb-4 border-b border-[#6B2D8B]/10 pb-2">Fertility Care</h3>
            <ul className="flex flex-col gap-y-3">
